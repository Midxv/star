        ...
        <div className="page-wrapper">
            ...
            <main className="content">
                ...
                <div className="policy-text">
                    ...
                    <p>Wallet balances are stored in a secure, encrypted database. While we implement industry-standard security measures, user are advised to use unique passwords. And we have NO RETURN POLICY ONCE ORDER IS PLACED</p>
